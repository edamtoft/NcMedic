...
public class MenuSelector extends FragmentActivity {
	public final static String EXTRA_PAGE_INDEX = "com.ncmedic.ncmedic.PAGE_INDEX";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		page = intent.getIntExtra(EXTRA_PAGE_INDEX, 0);
	...
	private ArrayList<Fragment> getFragments() {
		...
		result.add(Fragment.instantiate(this,
				ProtocolSearch.class.getName()));
		result.add(Fragment.instantiate(this,
				DrugSearch.class.getName()));
		result.add(Fragment.instantiate(this,
				Calculators.class.getName()));
		result.add(Fragment.instantiate(this,
				Tools.class.getName()));
		return result;
	}
